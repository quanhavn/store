-- Migration: Auto-create COGS (Cost of Goods Sold) expense when sale is completed
-- This tracks the cost of products sold for accurate profit calculation

-- ============================================================================
-- UPDATE create_sale FUNCTION - Add COGS expense creation
-- ============================================================================
...
BEGIN
    ...
    LOOP
        ...
        IF v_has_variant THEN
            -- Check variant stock and get cost_price
            SELECT quantity, COALESCE(cost_price, 0) INTO v_variant_qty, v_item_cost_price
            ...
            -- If variant has no cost_price, get from product
            IF v_item_cost_price = 0 THEN
