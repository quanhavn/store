-- Migration: Update create_sale to not calculate VAT in totals
-- Household business pays VAT to tax authority (not on invoices)
-- vat_rate is kept on sale_items for future tax reporting purposes

-- ============================================================================
-- UPDATE create_sale FUNCTION - Set vat_amount = 0, total = subtotal - discount
-- ============================================================================
